 ...
 */
package com.xwiki.licensing.internal.limitwarnings;
...
/**
 * Warning for licenses which are in danger of invalidation. For use in notification sending.
 ...
 * @version $Id$
 */
public abstract class AbstractLicenseWarningEvent implements TargetableEvent
{
    ...
    {
        return otherEvent instanceof AbstractLicenseWarningEvent;
    }
